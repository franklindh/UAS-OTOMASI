...
WebUI.setText(findTestObject('Object Repository/Page_/input_ID User_id_user'), 'tester_otomasi')
...
boolean loginSuccess = WebUI.click(findTestObject('Object Repository/Page_/input_Password_btn btn-primary btn-lg'))

if (loginSuccess) {
	WebUI.executeJavaScript("alert('Berhasil masuk!')")
} else {
